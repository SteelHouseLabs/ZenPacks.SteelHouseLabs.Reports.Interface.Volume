...
import logging
import os
log = logging.getLogger('zen.ZenPack.SteelHouseLabs.Reports.Interface.Volume')
...
class ZenPack(ZenPackBase):
    """ ZenPack.SteelHouseLabs.Reports.Interface.Volume Loader
    """

    packZProperties = [
                       ('zPerfReportableMetaTypes', ['IpInterface', 'Interface', 'CiscoEthernetInterface', 'CiscoInterface'], 'lines'),
                       ('zPerfReportableAvePeriodName', 'day', 'str'),
                       ('zPerfReportableAvePeriod', 86400, 'int'),]
